...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "c725fe04-2379-4daf-b0b2-4612b80bcc69",
...
const _vZ1VuISmErhw9d1q9MV99xVb9DfTXP8CMM5zZviOcjY = (function(nitro) {
...
const plugins = [
  _vZ1VuISmErhw9d1q9MV99xVb9DfTXP8CMM5zZviOcjY
];
...
const _ARpsAc = defineCachedEventHandler(async (event) => {
...
const _lazy_GdEK6r = () => import('../routes/api/jobs/_id_.get.mjs');
const _lazy_A2Xfuk = () => import('../routes/api/jobs/_id_.shortlist.delete.mjs');
const _lazy_zsMWAM = () => import('../routes/api/jobs/_id_.shortlist.post.mjs');
const _lazy_kWglnE = () => import('../routes/api/index.get.mjs');
const _lazy_wA5czB = () => import('../routes/api/runs.get.mjs');
const _lazy_WQfNqu = () => import('../routes/api/index2.get.mjs');
const _lazy_djaz_V = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/jobs/:id', handler: _lazy_GdEK6r, lazy: true, middleware: false, method: "get" },
  { route: '/api/jobs/:id.shortlist', handler: _lazy_A2Xfuk, lazy: true, middleware: false, method: "delete" },
  { route: '/api/jobs/:id.shortlist', handler: _lazy_zsMWAM, lazy: true, middleware: false, method: "post" },
  { route: '/api/jobs', handler: _lazy_kWglnE, lazy: true, middleware: false, method: "get" },
  { route: '/api/runs', handler: _lazy_wA5czB, lazy: true, middleware: false, method: "get" },
  { route: '/api/shortlist', handler: _lazy_WQfNqu, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_djaz_V, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _ARpsAc, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_djaz_V, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, withoutTrailingSlash as A, serialize$1 as B, defu as C, isEqual as D, upperFirst as E, handler as F, getQuery as a, defineRenderHandler as b, createError$1 as c, defineEventHandler as d, encodePath as e, destr as f, getRouterParam as g, getRouteRules as h, joinURL as i, joinRelativeURL as j, getResponseStatusText as k, getResponseStatus as l, useNitroApp as m, decodePath as n, hasProtocol as o, parseURL as p, isScriptProtocol as q, readBody as r, sanitizeStatusCode as s, klona as t, useRuntimeConfig as u, defuFn as v, withQuery as w, hash$1 as x, parseQuery as y, withTrailingSlash as z };
