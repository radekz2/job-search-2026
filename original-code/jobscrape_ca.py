...
# Canada-wide remote search
kw_ca_remote = [
    ("software manager", "Canada", True),
    ("technology manager", "Canada", True),
    ("IT manager", "Canada", True),
    ("director of technology", "Canada", True),
    ("director of software", "Canada", True),
    ("applications manager", "Canada", True),
]

results, seen = [], set()
for kw, loc, remote in kw_ca_remote:
    for start in (0,):
        try:
...
with open("/opt/data/resumes/results_ca_remote.json", "w") as f:
