#!/usr/bin/env python3
"""Scrape LinkedIn guest API + Canada Job Bank for job postings.

Stdlib-only. Writes intermediate JSON to ./resumes/results.json (LinkedIn)
and prints per-query tallies. Customize LI_KEYWORDS / JB_KEYWORDS for the
candidate's target titles and location.
"""
...
def main():
    ...
    li_keywords = [
        ("software manager", LOC, False), ("technology manager", LOC, False),
        ("IT manager", LOC, False), ("director of technology", LOC, False),
        ("director of software", LOC, False), ("applications manager", LOC, False),
        ("enterprise applications manager", LOC, False),
        ("director of software engineering", LOC, False),
        ("software manager", None, True), ("director of technology", None, True),
        ("technology manager", None, True), ("IT manager", None, True),
    ]
    jb_keywords = [
        "software manager", "technology manager", "IT manager",
        "director of technology", "director of software",
        "applications manager", "enterprise applications manager",
    ]
    ...
    with open("resumes/results.json", "w") as f:
